...
group: debbie
sensitivity: 0.4
tags: [debbie, marketing, seo, ai-visibility, dir, fet-priced]
skills:
  - name: standard
    price: 0.05
    tags: [dir, standard]
...
aliases:
  agentverse: debbie-niche-directory
  token: $DIR
---
...
|----------------|-------------------|
| `debbie:citation` | batch sibling submissions |
...
`SUI_SEED + debbie:niche-dir` — no private keys stored).
