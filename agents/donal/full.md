...
group: marketing
sensitivity: 0.4
tags: [donal, marketing, seo, ai-visibility, full, fet-priced]
skills:
  - name: standard
    price: 1
    tags: [full, standard]
...
|----------------|-------------------|
| `marketing:quick` | VSL hook upsells to full audit |
...
| `marketing:monthly` | full audit feeds retainer reports |
...
emit({ receiver: 'marketing:monthly', data: result })  // full audit feeds retainer reports
```
...
`SUI_SEED + marketing:full` — no private keys stored).
