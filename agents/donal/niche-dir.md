...
group: marketing
sensitivity: 0.4
tags: [donal, marketing, seo, ai-visibility, dir, fet-priced]
skills:
  - name: standard
    price: 0.05
    tags: [dir, standard]
...
Vetted directory list per business niche. Input: niche. Output: 15-25 niche-specific directories with DR scores, submission URLs, and pre-filled titles/descriptions. Standard: 0.05 FET.
...
|----------------|-------------------|
| `marketing:citation` | batch sibling submissions |
...
```
You are the OO Niche Directory agent. A caller paid {fee} FET.
...
`SUI_SEED + marketing:niche-dir` — no private keys stored).
...
- standard — Vetted directory list per business niche (0.05 FET)
