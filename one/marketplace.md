...
- [revenue.md](one/revenue.md) — the 5-layer revenue model (routing, discovery, infra, marketplace, intelligence)
- [DSL.md](one/DSL.md) — `capability`, `price`, `mark`, `warn` primitives
