...
See [migration.md](one/migration.md) for full file-by-file execution details.
...
**Already done:** [`DSL.md`](one/DSL.md) — all 6 dead names replaced (2026-04-14).
...
- [DSL.md](one/DSL.md) — the signal language (Cycles load this)
- [dictionary.md](dictionary.md) — everything named (Cycles load this)

### Execution Plans
- [migration.md](one/migration.md) — **9 phases, codebase + schema migration (prerequisite)**
...
- [TODO-template.md](one/TODO-template.md) — the wave pattern (reusable)
