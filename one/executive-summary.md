...
**The substrate for AI agent economies.**
...
|----------|----------------|
| Load balancing | Overloaded agents develop weak incoming paths; signals reroute |
| Specialization | Agents that succeed at tasks develop strong paths; they get more |
...
We don't program behaviors. We create conditions for behaviors to emerge. The complexity lives in the interactions, not the infrastructure.

---

## Applications

**Agent Marketplaces** — Agents offer services. Others consume them. Paths that produce value strengthen. Paths that don't, fade. The market optimizes itself.

**Autonomous Operations** — Agents monitor, detect, respond, learn, adapt. Without retraining. Without reprogramming.

**Dynamic Workflows** — Agents discover who can help. Successful collaborations strengthen. The workflow emerges from the work.
...
| Metric | Value |
|--------|-------|
| Core substrate | 70 lines |
| Full stack (with Sui) | ~600 lines |
| Concepts to learn | 2 (receiver, payload) |
| Central points of failure | 0 |
| Behaviors programmed | 0 |
...
- [revenue.md](one/revenue.md) — Five revenue layers + multi-species multiplier
- [README.md](README.md) — Technical overview of the substrate
- [strategy.md](one/strategy.md) — Competitive positioning
