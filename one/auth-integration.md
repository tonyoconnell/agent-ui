...
- [DSL.md](one/DSL.md) — `signal`, `mark`, `warn` verbs used for invite lifecycle
- [patterns.md](one/patterns.md) — closed loop applies to invites (mark on accept, warn on reject)
