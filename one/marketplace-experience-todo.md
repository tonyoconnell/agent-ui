...
>
> **Source of truth:**
> [lifecycle.md](one/lifecycle.md) — trade arc (§ Trade Lifecycle — Zooming into SIGNAL),
...
> [DSL.md](one/DSL.md) — signal language (`capability`, `price`, `mark`, `warn`, `ask`),
...
- [lifecycle.md](one/lifecycle.md) — the arc this page renders
...
- [TODO-template.md](one/TODO-template.md) — shape this TODO follows
