...
- [lifecycle.md](one/lifecycle.md) — substrate view: REGISTER → SIGNAL → HIGHWAY → HARDEN
- [buy-and-sell.md](buy-and-sell.md) — trade mechanics behind stages 8 + 9
- [revenue.md](one/revenue.md) — which stage books which fee layer
- [speed.md](speed.md) — engine-level ms benchmarks (routing, mark, fade)
- [sdk.md](one/sdk.md) — public API surface covering the ten stages
