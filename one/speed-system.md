...
> benchmark matrix live in [speed.md](one/speed.md). This doc is the **narrative**
...
Every stage of [lifecycle.md](one/lifecycle.md) touches specific layers. This
...
- [speed.md](one/speed.md) — the full benchmark matrix and aspirational targets
