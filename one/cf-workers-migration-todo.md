...
> [DSL.md](one/DSL.md) — signal grammar (unchanged), [rubrics.md](rubrics.md) —
...
- [x] **Cycle 3: GROW** — Cutover + Cleanup — *complete (2026-04-19); dev.one.ie → Workers, Pages paused, docs swept*
  ...
  - [x] W3 — Edits (env: `PUBLIC_GATEWAY_URL` ✓ in `deploy.yml`; DNS flip tool: ✓ `scripts/cf-cutover.ts`; redeploy + flip: ✓ done; docs: 10 files swept — CLAUDE.md, deploy.md, cloudflare.md, DOMAIN-CONFIG.md, astro-cloudflare-pattern.md, SECURE-DEPLOY.md; memory — updated)
  - [x] W4 — Verify (biome + tsc + vitest 560/560 green; no stale `wrangler pages deploy` in touched files; rubric 0.80)
...
- [DSL.md](one/DSL.md) — signal grammar (unchanged across migration)
...
- [TODO-template.md](one/TODO-template.md) — template this TODO was built from
