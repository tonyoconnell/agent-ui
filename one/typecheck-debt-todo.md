...
>
> **Source of truth:** [dictionary.md](dictionary.md) — canonical types; [DSL.md](one/DSL.md) — `RichMessage` contract; [rubrics.md](rubrics.md) — W4 scoring; [.claude/rules/engine.md](../.claude/rules/engine.md) — Rule 3 (Deterministic Results in Every Loop).
>
...
- [DSL.md](one/DSL.md) — RichMessage contract (authoritative)
- [rubrics.md](rubrics.md) — fit/form/truth/taste weighting
- [TODO-template.md](one/TODO-template.md)
