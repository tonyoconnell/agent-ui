...
> [DSL.md](one/DSL.md) — the signal language (`capability`, `price`, `mark`, `warn`),
...
**[DSL.md](one/DSL.md)** — `capability`, `price`, `mark`, `warn`, `ask`
**[dictionary.md](dictionary.md)** — canonical names
...
- [rubrics.md](rubrics.md) — fit/form/truth/taste scoring
- [TODO-template.md](one/TODO-template.md) — the shape this follows
