...
- [patterns.md](one/patterns.md) — closed loop, zero returns
- [lifecycle.md](one/lifecycle.md) — agent journey (register → highway → harden)
- [TODO-template.md](one/TODO-template.md) — source of this shape
