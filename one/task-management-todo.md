...
>
> **Source of truth:** [DSL.md](one/DSL.md) — the signal language,
...
|------|-----------|-------|
| Signal grammar | [DSL.md](one/DSL.md) | `{ receiver, data }` — loaded in every W2 |
...
| Wave pattern | [TODO-template.md](one/TODO-template.md) | W1-W4, cycles, model assignment |
