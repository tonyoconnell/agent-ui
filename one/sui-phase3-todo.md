...
W1 recon     — [x] Complete (3 Haiku agents: Move ✓ · sui.ts ✓ · hire/settle ✓)
W2 decide    — [x] Complete (4 decisions: release/cancel routes, TypeQL fix, tests)
W3 edit      — [x] Complete (4 Sonnet agents: release ✓ · cancel ✓ · TypeQL ✓ · tests ✓)
W4 verify    — [x] Complete (1581→1574 tests, 7 real settlement tests, biome clean)
```
...
- [revenue.md](one/revenue.md) — 50 bps fee goes to L4 economics layer
