...
**All targets met.** 5/5 tests pass. [Full results →](2026-04-06-dev-verified.json)
...
See [raw test data](2026-04-06-dev-verified.json) for fade_decay with 100 edges at 50 runs: p50=0.01 ms, p95=0.01 ms, p99=0.05 ms, max=0.05 ms.
...
**Measured performance:** See [full results](2026-04-06-dev-verified.json).
...
**Raw data:** [2026-04-06-dev-verified.json](2026-04-06-dev-verified.json)
