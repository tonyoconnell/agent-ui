...
- [x] **Cycle 1: WIRE** — clone `../ONE/cli` + scaffold `@oneie/*` packages ✓ 2026-04-15
...
- [x] **Cycle 2: PROVE** — substrate verbs + launch handoff ✓ 2026-04-15
...
- [x] **Cycle 3: GROW** — docs + MCP HTTP + self-improvement ✓ 2026-04-15
...
- [copy-reports/mcp.md](one/reports/mcp.md) — MCP router shape (no tokenize tools)
- [copy-reports/sdk.md](one/reports/sdk.md) — `@oneie/sdk` surface
- [copy-reports/templates.md](one/reports/templates.md) — preset merge plan
- [copy-reports/launch-api.md](copy-reports/launch-api.md) — agent-launch HTTP contract
- [copy-reports/skill-scripts.md](skill-scripts.md) — SKILL.md + smoke tests
- [TODO-template.md](one/TODO-template.md) — wave pattern used here
