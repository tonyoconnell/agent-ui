...
ai_context: |
  ...
  Location: one/things/claude/agents/the-bull-character-manager.md
  Purpose: Documents the-bull-character-manager
  Related dimensions: events, people
  For AI agents: Read this to understand the bull character manager.
---

# the-bull-character-manager
...
- **Morning**: Market commentary with coffee/energy drink props
...
_CASCADE Agent: THE-BULL-CHARACTER-MANAGER with Context Intelligence_
