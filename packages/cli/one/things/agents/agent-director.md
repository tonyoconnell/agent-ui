...
- **[1-1-agent-prompts.md](packages/cli/one/things/features/1-1-agent-prompts.md)** - Agent prompts feature specification
...
- **[CLAUDE.md](packages/cli/CLAUDE.md)** - Platform development guide
