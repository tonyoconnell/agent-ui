...
6. **[knowledge.md](packages/cli/one/learning/knowledge.md)** - Vectors, embeddings, RAG (what it means)

**Execution Guide:**

7. **[todo.md](packages/cli/one/learning/todo.md)** - 100-cycle execution sequence (plan in cycles, not days)
...
**Planning Paradigm:** We don't plan in days. We plan in **cycle passes** (Cycle 1-100). See [todo.md](packages/cli/one/learning/todo.md) for the complete 100-cycle template that guides feature implementation from idea to production.
