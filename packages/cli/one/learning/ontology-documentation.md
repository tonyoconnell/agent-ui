...
1. **[groups.md](packages/cli/one/groups/groups.md)** - Multi-tenant containers
...
6. **[knowledge.md](packages/cli/one/learning/knowledge.md)** - Vectors & cycle
...
**[Ontology.md](packages/cli/one/learning/ontology.md)** - The single source of truth
...
1. Read **[Ontology.md](packages/cli/one/learning/ontology.md)** (complete spec)
...
1. Start with **[ontology.md](packages/cli/one/learning/ontology.md)** - Complete 6-dimension specification
