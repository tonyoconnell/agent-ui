...
> 298), The Tick (line 852); [DSL.md](DSL.md) — the public `send()` API;
> [routing.md](routing.md) — The Formula, Two Routing Modes, The Layers,
> Signal Lifecycle; [TODO-template.md](TODO-template.md) — the wave pattern.
>
...
| [DSL.md](DSL.md) | Public signal API | Already uses `send()`; no mention of command surface |
...
- [DSL.md](DSL.md) — `send()` is the public verb
...
- [TODO.md](TODO.md) — parallel execution plan
