...
> [revenue.md](revenue.md) — five revenue layers (pricing tasks)
>
...
- [lifecycle.md](lifecycle.md) — agent career arc
- [TODO-template.md](TODO-template.md) — wave structure template
