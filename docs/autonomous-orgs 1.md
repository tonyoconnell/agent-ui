...
fun critical_path() -> { task }:
  match
    $t isa task, has phase "week-1";  # Phase 1 always on critical path
  return { $t };
...
### Initial Task Setup (Phase 1: Week 1)

```typeql
# Week 1 Phase Group
insert $g isa group,
  has gid "phase:week-1",
  has name "Week 1: Foundation",
  has purpose "Marketing alive. First signals. First learning.",
  has group-type "phase",
  has status "active";
...
insert $t1 isa task,
  ...
  has persona "ceo",
  has priority 95,
  has priority-formula "critical=30 + week-1=40 + ceo_weight=3x=25",
  has tag "marketing", has tag "P0", has tag "agents", has tag "telegram",
  has status "pending",
  has due-date 2026-04-14,
...
insert $t2 isa task,
  ...
  has persona "dev",
  has priority 90,
  has priority-formula "critical=30 + week-1=40 + dev_weight=2.5x=20",
...
insert $t3 isa task,
  ...
  has persona "dev",
  has priority 85,
  has priority-formula "high=25 + week-1=40 + enables_marketing=20",
...
insert $t4 isa task,
  has task-id "pheromone-dashboard-week1",
  ...
  has persona "ceo",
  has priority 70,
  has priority-formula "medium=20 + week-1=40 + enables_strategy=10",
...
```
PHASE              AGENTS  AVG SIGNAL/DAY  PRICE    REVENUE/DAY    MARGIN (30%)
─────────────────────────────────────────────────────────────────────────────────
Week 1             8       100             $0.02    $16            $4.80
Week 2             12      500             $0.025   $150           $45
Week 4             15      2000            $0.03    $1,800         $540
Month 2            30      10000           $0.03    $9,000         $2,700
Month 3            100     50000           $0.03    $45,000        $13,500
Month 6            1000    100000          $0.03    $90,000        $27,000
Year 1             10000   500000          $0.035   $1,750,000     $525,000
```

**Critical insight:** By Month 2, we're $2,700/day. By Month 3, we're cash-flow positive at scale.
...
──────────────────────────────────────────────────────────
Cash Flow Positive          Month 2     $2,700/day × 30 = $81,000/month
Retention (30-day)          >90%        <1 agent churn per 100
Agent Earnings              >$100/mo    (ensures freelancer quality)
...
## Part 8: The Bootstrap Sequence (Week by Week)
...
**Success Criteria:** 8 agents live, 100 signals/day, dashboard shows paths
...
**Signals/Day:** 500
**Success:** 2-3 highways formed (marketing→sales, engineering→review)
...
**Signals/Day:** 2,000
**Success:** x402 working, 1+ paying external agents
...
**Revenue:** $2,700/day
**Agents:** 30+
**Success:** Cash flow positive, adoption accelerating
...
**Revenue:** $13,500/day
**Agents:** 100+
**Success:** Data moat forming (knowing what works matters more than being first)
...
│                                                          │
│  THE STRATEGY (ONE-strategy.md → TODO):                 │
│  Week 1:  Marketing (8 agents, Telegram, first routes)  │
│  Week 2:  Engineering (cross-team signals, highways)    │
│  Week 4:  Sales (revenue on Sui, x402)                  │
│  Month 2: External agents (markdown, AgentVerse)        │
│  Month 6: Sensitivity products (explorer/harvester)     │
│  Year 1:  10,000+ agents, self-forming teams            │
│                                                          │
│  THE MACHINE:                                           │
...
│                                                          │
│  THE MONEY:                                             │
│  Week 1:    $4.80/day    (internal learning)            │
│  Week 4:    $540/day     (first external agent)         │
│  Month 2:   $2,700/day   (10+ external agents)          │
│  Month 3:   $13,500/day  (100 agents, highways proven)  │
│  Year 1:    $525,000/mo  (10,000 agents)                │
│                                                          │
│  THE MOAT:                                              │
...
- [ ] **Revenue:** Wire x402 payment routing on Sui (Month 2)
