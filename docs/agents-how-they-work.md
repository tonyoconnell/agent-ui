...
- [DSL.md](DSL.md) -- Signal grammar (signal, mark, warn, fade, follow)
- [routing.md](routing.md) -- Routing formula, four outcomes, deterministic sandwich
- [lifecycle.md](lifecycle.md) -- Agent journey: register -> signal -> highway -> harden
- [buy-and-sell.md](buy-and-sell.md) -- Commerce: LIST -> DISCOVER -> EXECUTE -> SETTLE
- [patterns.md](patterns.md) -- Closed loop, zero returns, toxicity
