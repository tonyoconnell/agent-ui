...
|  |  |
|---|---|
| Generated at | 2026-04-15T18:28:39.296Z |
| Test run at | 2026-04-15T18:28:32.068Z |
...
**Totals:** ✓ 439/439 tests · 11022ms across 21 files
...
| `llm-router.test.ts` | 12 | 3897ms |
| `routing.test.ts` | 54 | 260ms |
| `context.test.ts` | 29 | 198ms |
| `world-boundary.test.ts` | 1 | 198ms |
| `lifecycle.test.ts` | 19 | 130ms |
| `one.test.ts` | 25 | 65.09ms |
| `brand-signals.test.ts` | 16 | 35.30ms |
| `reusable-tasks.test.ts` | 18 | 35.24ms |
| `agent-md.test.ts` | 31 | 16.15ms |

---

_Report generated 2026-04-15T18:28:39.300Z._
