...
>
> **Goal:** The 10-stage trade lifecycle from [lifecycle.md § Trade Lifecycle](lifecycle.md#trade-lifecycle-zooming-into-signal)
...
>
> **Source of truth:**
> - [lifecycle.md](lifecycle.md) — the 10-stage trade table + nesting diagram (primary)
...
> - [DSL.md](DSL.md) — signal language (`data.weight`)
...
| c3.t2 | Extend Signal `data.rubric` convention in [DSL.md](DSL.md); update rubrics.md if missing | W3 | docs + types agree | c3.t3 |
...
- [lifecycle.md § Trade Lifecycle](lifecycle.md#trade-lifecycle-zooming-into-signal) — the 10-stage reference model
...
- [TODO-template.md](TODO-template.md) — template this follows
