...
See also: [speed.md](./speed.md), [rubrics.md](./rubrics.md),
...
- Compares p50/p95 against budgets sourced from [speed.md](./speed.md)
...
CI runs `PERF_SCALE=1` on idle runners. See [speed.md](./speed.md).
...
- [speed.md](./speed.md) — the benchmarks tests verify
...
- [DSL.md](./DSL.md) — signal language tests speak
