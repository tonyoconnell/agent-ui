...
async function analyzeToken(params: z.infer<typeof analyzeTokenParams>): Promise<TokenAnalysisResult> {
  ...
  if (analysisType !== 'quick') {
    const volatilityRisk = calculateVolatilityScore(performance.change24h, performance.change7d, performance.change30d)
...
export const analyzeTokenTool: Tool = {
  ...
  description:
    'Comprehensive AI-powered cryptocurrency token analysis. Returns overview, metrics, performance data, and risk assessment. Supports quick, deep, risk, and comprehensive analysis modes.',
  category: 'data',
...
async function calculateRiskScore(params: z.infer<typeof riskScoreParams>) {
    ...
    categories: [
      {
        ...
        description:
          analysis.riskAssessment.volatilityRisk < 30
      ...
      },
      {
        ...
        description:
          analysis.riskAssessment.liquidityRisk < 30
  ...
  return {
    ...
    tableData,
    recommendation:
      riskBreakdown.overall.score < 30
...
export const riskScoreTool: Tool = {
  ...
  description:
    'Calculate comprehensive risk score for a cryptocurrency token. Returns detailed breakdown of volatility, liquidity, and concentration risks with recommendations.',
  category: 'data',
