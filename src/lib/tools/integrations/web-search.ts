...
async function webSearch(params: z.infer<typeof webSearchParams>) {
  ...
  if (!apiKey) {
    throw new Error('EXA_API_KEY is required. Get your API key at https://exa.ai and add it to your .env file.')
  }
...
export const webSearchTool: Tool = {
  name: 'web_search',
  description:
    'Search the web for current information. Use this to find facts, news, or answers to questions that require up-to-date information.',
