...
export const weatherTool: Tool = {
  name: 'get_weather',
  description: 'AUTOMATICALLY get current weather for any location worldwide. Returns temperature (°F), feels like, humidity, wind speed, and weather description. No API key needed - powered by Open-Meteo.',
