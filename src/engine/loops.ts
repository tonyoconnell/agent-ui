 ...
 */
export const signalLoop = (net: PersistentWorld) => loop<Signal>(
  signals(net),
  first(),
  async (sig) => {
 ...
 */
export const fadeLoop = (net: PersistentWorld) => loop<{ action: 'fade' }>(
  fadeAction(),
  first(),
  () => {
    net.fade(FADE_RATE)
 ...
 */
export const evolveLoop = (net: PersistentWorld, complete: Complete) => compose<StrugglingUnit, Advisor>(
  {
 ...
 */
export const knowLoop = (net: PersistentWorld, cycle: number) => loop<{ action: 'know' }>(
  knowAction(),
  first(),
  async () => {
 ...
 */
export const frontierLoop = (net: PersistentWorld, cycle: number) => loop<{ action: 'know' }>(
  knowAction(),
  first(),
  async () => {
    let frontierCount = 0
