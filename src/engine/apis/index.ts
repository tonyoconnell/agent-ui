...
export const github = (token: string) =>
  apiUnit('github', {
...
export const notion = (token: string) =>
  apiUnit('notion', {
...
export const linear = (token: string) =>
  apiUnit('linear', {
    base: 'https://api.linear.app',
    auth: `Bearer ${token}`,
  })

export const pagerduty = (token: string) =>
  apiUnit('pagerduty', {
    base: 'https://api.pagerduty.com',
    auth: `Token token=${token}`,
  })

export const mailchimp = (token: string, dc: string) =>
  apiUnit('mailchimp', {
    base: `https://${dc}.api.mailchimp.com/3.0`,
    auth: `Bearer ${token}`,
  })

export const discord = (botToken: string) =>
  apiUnit('discord', {
    base: 'https://discord.com/api/v10',
    auth: `Bot ${botToken}`,
  })

export const stripe = (secretKey: string) =>
  apiUnit('stripe', {
