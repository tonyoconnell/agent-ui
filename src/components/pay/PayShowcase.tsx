  ...
  return (
    <div className="w-full">
      ...
      <main className="w-full max-w-6xl mx-auto px-4 md:px-6">
        ...
        <Pillars />
        <HowItWorks />
        <LiveDemo receipt={receipt} setReceipt={setReceipt} />
        <Pricing />
        <DeveloperBlock />
        <FinalCTA cta={cta} />
      </main>
...
// ═══════════════════════════════════════════════════════════════════════════
// Live demo — the components, reframed as "try it"
// ═══════════════════════════════════════════════════════════════════════════
function LiveDemo({ receipt, setReceipt }: { receipt: string | null; setReceipt: (r: string | null) => void }) {
  return (
    <section id="demo" className="py-20 border-t border-zinc-900 scroll-mt-14">
      <SectionHeader
        eyebrow="Try it live"
