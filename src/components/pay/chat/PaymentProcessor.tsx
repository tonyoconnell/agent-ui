    ...
    <Card className="border-primary">
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-[hsl(var(--color-primary-bright)/0.15)] border border-[hsl(var(--color-primary-mid))] p-4 rounded-md space-y-3">
            <div>
              <p className="text-sm font-semibold text-[hsl(var(--color-primary-bright))] mb-2">How Payment Works</p>
              <p className="text-xs text-[hsl(var(--color-primary-bright))] leading-relaxed">
            ...
            <div className="pt-2 border-t border-[hsl(var(--color-primary-mid))]">
              <p className="text-xs text-[hsl(var(--color-primary-bright))] leading-relaxed">
          ...
          {!sptToken ? (
            ...
            <div className="bg-[hsl(var(--color-tertiary-bright)/0.15)] border border-[hsl(var(--color-tertiary-mid))] p-3 rounded-md">
              <p className="text-xs font-mono text-[hsl(var(--color-tertiary-bright))] break-all">{sptToken}</p>
