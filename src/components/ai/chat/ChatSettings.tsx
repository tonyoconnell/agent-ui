...
import { X, Key, Save, Trash2, Info } from "lucide-react";
...
import { secureGetItem, secureSetItem, secureRemoveItem } from "@/lib/security";
					...
					<CardContent className="space-y-6">
						...
						<div className="space-y-3">
							...
							<Alert>
								...
								<AlertDescription>
									Free models work without an API key. Premium models (GPT-5,
									Claude Sonnet 4.5, etc.) require an OpenRouter API key.
									<a
							...
							<div className="grid gap-3">
								<div className="flex items-center justify-between p-3 rounded-lg border">
									<div>
										...
										<p className="text-xs text-muted-foreground">
											Gemini Flash, Sherlock Think, DeepSeek
										</p>
									</div>
								...
								<div className="flex items-center justify-between p-3 rounded-lg border">
									<div>
										...
										<p className="text-xs text-muted-foreground">
											GPT-5, Claude Sonnet 4.5, Gemini Pro
										</p>
									</div>
