...
import { User, Bot, Copy, CheckCheck, Search, FileText, Lightbulb, CheckCircle } from "lucide-react";
							...
							<ChainOfThoughtContent>
								{message.chainOfThought?.map((step) => (
									<ChainOfThoughtStep
										...
										status={step.status}
										icon={step.icon === "search" ? Search : step.icon === "file" ? FileText : step.icon === "lightbulb" ? Lightbulb : CheckCircle}
									/>
								))}
							</ChainOfThoughtContent>
						</ChainOfThought>
					...
					{isUser ? (
						<div className="flex justify-end items-start gap-4">
							<div className="relative bg-[hsl(var(--color-sidebar))] rounded-2xl px-4 py-3 max-w-[85%] border-2 border-border">
								<p className="whitespace-pre-wrap break-words text-base leading-[1.6]">
									{message.content}
								</p>
							</div>
