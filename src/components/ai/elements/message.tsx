...
export const Message = ({ className, from, ...props }: MessageProps) => (
  <div
    className={cn(
      ...
      from === 'user' ? 'is-user ml-auto justify-end max-w-[80%]' : 'is-assistant md:max-w-[80%]',
      className,
    )}
    {...props}
  />
...
export const MessageActions = ({ className, children, ...props }: MessageActionsProps) => (
  <div
    className={cn(
      'flex items-center gap-1 justify-end bg-background/95 backdrop-blur-sm rounded-md px-2 py-1',
      className,
    )}
    {...props}
  >
