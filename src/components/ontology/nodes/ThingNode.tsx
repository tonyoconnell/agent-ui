  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          borderColor: selected ? 'hsl(var(--color-tertiary-bright))' : 'hsl(var(--color-tertiary-mid))',
          background: 'hsl(var(--color-tertiary-bright) / 0.05)',
          outline: selected ? '2px solid hsl(var(--color-tertiary-mid))' : 'none',
          outlineOffset: '2px',
        }}
      ...
      >
        <Handle
          ...
          id="top"
          style={{ background: 'hsl(var(--color-tertiary-mid))' }}
        />
        <Handle
          type="source"
        ...
        {/* Type icon */}
        <span className="text-[16px] text-tertiary-bright leading-none select-none pointer-events-none">{icon}</span>

        {/* Label truncated */}
        <span className="px-1 text-foreground text-[9px] font-medium leading-tight text-center truncate w-full">
          {label}
        </span>
        ...
        {price !== undefined && price > 0 && (
          <span
            ...
            style={{
              background: 'hsl(var(--color-tertiary-bright) / 0.2)',
              color: 'hsl(var(--color-tertiary-bright))',
              border: '1px solid hsl(var(--color-tertiary-mid))',
            }}
          >
            ${price.toFixed(2)}
          </span>
