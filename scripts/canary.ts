...
const CANARY_EXPECTED_ADDRESS =
  "0xd0c2c91eda34bbfbaec6cfb9c7bb913e57dab3cbec4018a4b3f5e55531cd63af"
...
async function main() {
  ...
  if (address !== CANARY_EXPECTED_ADDRESS) {
    console.error(
      `CANARY FAIL: expected ${CANARY_EXPECTED_ADDRESS}, got ${address}`,
    )
    console.error(
      "Sui address derivation has diverged. Block the deploy and investigate @mysten/sui version.",
    )
    process.exit(1)
  }
