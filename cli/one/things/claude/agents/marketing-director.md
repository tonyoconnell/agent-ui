...
ai_context: |
  ...
  Location: one/things/claude/agents/marketing-director.md
  Purpose: Documents siobhan o'brien - marketing strategy director
  Related dimensions: connections, events, knowledge
  For AI agents: Read this to understand marketing director.
---
...
_CASCADE Agent: MARKETING-DIRECTOR with Context Intelligence_
