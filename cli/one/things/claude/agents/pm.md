...
ai_context: |
  ...
  Location: one/things/claude/agents/pm.md
  Purpose: Documents pm
  Related dimensions: knowledge, people
  For AI agents: Read this to understand pm.
---
...
**CASCADE-Enhanced pm with Context Intelligence and Performance Excellence**
...
_CASCADE Agent: PM with Context Intelligence_
